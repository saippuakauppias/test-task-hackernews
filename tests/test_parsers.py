...
def test_parse_topstories(requests_mock):
    ...
    assert 'https://element.io/blog/welcome-to-element/' == \
           posts['23842179']['url']
    assert 'Riot is now Element' == posts['23842179']['title']
    # last post
    assert '23834153' in posts.keys()
    assert 'https://jordanlewis.org/posts/twitch-live-coding/' == \
           posts['23834153']['url']
    assert 'How to Run a Live Coding Stream on Twitch Using OBS' == \
           posts['23834153']['title']
